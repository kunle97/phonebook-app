      ...
      <div class="row">
         <div class="col-md-4 mx-auto">
            <div class="myform form ">
               <form action="/signup" method="post" name="sign-up">
                  <div class="form-group">
                     <input type="text" name="name"  value="testuser1" class="form-control my-input" id="name" placeholder="Name">
                  </div>
                  <div class="form-group">
